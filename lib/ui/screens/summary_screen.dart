  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) {
        ...
        if(projectsState.chosenProject != null) {
          bloc.add(LoadSummary(
            project: projectsState.chosenProject!
          ));
        }
        return bloc;
      },
            ...
            child: BlocListener<ProjectsBloc, ProjectsState>(
              listener: (context, projectsState) {
                if(projectsState is ProjectsLoaded && projectsState.chosenProject != null) {
                  context.read<SummariesBloc>().add(LoadSummary(
                    project: projectsState.chosenProject!
                  ));
                }
              },
                          ...
                          BlocBuilder<ProjectsBloc, ProjectsState>(
                            builder: (context, projectsState) {
                              ...
                              return Expanded(
                                child: SummaryBox(
                                  label: 'Proyecto',
                                  value: projectsState.chosenProject?.name ?? 'No seleccionado',
                                )
                              );
                            }
                          )
